...
export default function Navbar(props: Props) {
    ...
    return (
        <Box sx={{display: 'flex'}}>
            <CssBaseline/>
            <AppBar component="nav" style={{backgroundColor: '#0F182A'}} elevation={0}>
                <Toolbar>
                    <IconButton
                        color="inherit"
                    ...
                    <Grid container justifyContent={'flex-end'} spacing={3} alignItems={'center'}>
                        {navItems.map((item) => (
                            <Grid item key={item} sx={{display: {xs: 'none', sm: 'block'}}}>
                                <Typography
                                    color={'primary'}
                                    variant={'body2'}
                                    style={{
                        ...
                        <Grid item>
                            <Button color={'primary'} variant={'outlined'}>Resume</Button>
                        </Grid>
                    </Grid>
                </Toolbar>
            </AppBar>
